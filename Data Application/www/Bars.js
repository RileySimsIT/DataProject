function barsLoad(){
    var dhtml = `       
        ...
        <div id="wrap" style="width:80%; margin-left:10%; margin-top:20px; margin-bottom:40px;" >
            ...
            <div id="container" style="width:100%; border: 1px solid black; height:50px; background:white; margin-bottom:30px; box-shadow: 2px 5px #888888;">
                <div id="bar5" style="height:50px;"></div>
            </div>
            <button id="btnBars" onclick="barsLoad()" class="menuButton" style="margin-top:30px; width:40%; margin-left: 5%; float:left;">Refresh</button>
            <button onclick="menu();" class="menuButton" style="margin-top:30px; width:40%; margin-right: 5%; float:right;">Main Menu</button>
        </div>`;
    ...
    val = val + "%";
    document.getElementById("bar5").style.background=color;
    document.getElementById("bar5").style.width=val;
}